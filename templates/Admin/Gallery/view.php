...
<section class="gallery view card">
    <div class="card-content">
        ...
        <div class="row">
            <div class="d-flex jc-end">
                <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $gallery->id], ['confirm' => __('Are you sure you want to delete {0}?', $gallery->title), 'class' => ['btn', 'cancel']]); ?>
